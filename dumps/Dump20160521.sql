...
CREATE TABLE `corral` (
  ...
  CONSTRAINT `fk_corral_Estado1` FOREIGN KEY (`estado_id_estado`) REFERENCES `estado` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `corral` VALUES (1,1,30,0),(2,2,40,0),(3,3,35,0),(4,4,45,0);
...
-- Dump completed on 2016-05-21 13:53:46
